...
own-settings: ## Make the settings.php file writable
	chmod -R 775 drupal/settings.php
...
reinstall-site: ## Delete and reinstall the site. This deletes the database.
...
zap: destroy ## Delete the entire Docker environment and start from scratch.
